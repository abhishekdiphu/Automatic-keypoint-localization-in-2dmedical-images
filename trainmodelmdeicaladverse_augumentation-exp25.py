...
from datasets.legmedical_augumentation import HANDXRAY
...
modelpath_g = torch.load('train-model-16-medical-adversarial-pre-trainied-660-data-augm/modeladversarial_59_500.pt')
generator_model = modelpath_g['generator_model']
#print(generator_model)
#print(generator_model)
#print(discriminator_model)

modelpath_d = torch.load('train-model-16-medical-adversarial-pre-trainied-660-data-augm/modeladversarial_47_500.pt')
...
#                                                                    ground_truth =ground_truth['heatmaps'])
        ...
        loss = cur_gen_loss     + (cur_disc_loss_dic_pose)      #/220. 
