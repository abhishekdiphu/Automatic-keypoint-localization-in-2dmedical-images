...
class HANDXRAY(Dataset):
    ...
    def _get_files(self):
        ...
        self.annot = hiwi.ImageList.load('/home/aburagohain/training_test_list/fold5_test.iml') #fold5_training
        #print("length of images",self.annot[821].data)
        print("length of images",len(self.annot))
        self.files = hiwi.ImageList.load('/home/aburagohain/training_test_list/fold5_test.iml') #fold5_training
