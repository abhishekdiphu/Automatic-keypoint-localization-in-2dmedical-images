...
parser.add_argument('--train_split', type=float, default=.804)
...
class HANDXRAY(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        c = np.array([file_name.shape[1]/2 , file_name.shape[0]/l])  #2 #8 #1.02
        ...
        return {
            ...
            'small_image'  : torch.Tensor(original.astype(np.float32)) #.transpose(2 , 0 , 1)
