...
modelpath_g = torch.load('train-model-19/supervised-medical-660-lr-0002/experiment01-batch-size-1/model_78_520.pt')
generator_model = modelpath_g['generator_model']
#print(generator_model)
#print(generator_model)
#print(discriminator_model)

modelpath_d = torch.load('train-model-31/pretrained_pose_sh_glass/experiment03_pretrain_pose/pretrained_conf_pose_79_500.pt')
...
#    optim_disc_conf = optim.Adam(discriminator_model_conf.parameters(), lr=args.lr) ##added the betas.originally not there 
    ...
    scheduler =ReduceLROnPlateau(optim_disc_pose, mode='min', factor= 0.3  , patience=5, verbose=True)
...
for epoch in range(args.epochs):
    ...
    print("current lr:" , optim_disc_pose.param_groups[0]['lr'])
...
#        print("---------------------pose Discriminator training-------------------------------------------------")
        ...
        running_loss += cur_disc_loss.item()
...
#                                                                    ground_truth =ground_truth['heatmaps'])
        ...
        loss = cur_gen_loss     + (cur_disc_loss_dic_pose)/180.0   #/220.0      #138.0      #/220. config.
